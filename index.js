...
async function connectToWA() {
  ...
  console.log("Connecting Mitzukyy-MD");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("Mitzukyy-MD installed successful ✅");
      console.log("Mitzukyy-MD connected to whatsapp ✅");

      let up = `Mitzukyy-MD connected successful ✅`;
      let up1 = `Hello Robin, I made bot successful`;

      robin.sendMessage(ownerNumber + "@s.whatsapp.net", {
        image: {
          url: `https://i.ibb.co/LX1JWyZZ/Z9-XLim-Getd.jpg`,
        },
        caption: up,
      });
      robin.sendMessage("94721931393@s.whatsapp.net", {
        image: {
          url: `https://i.ibb.co/LX1JWyZZ/Z9-XLim-Getd.jpg`,
        },
        caption: up1,
...
app.get("/", (req, res) => {
  res.send("hey, Mitzukyy-MD started✅");
});
app.listen(port, () =>
